"""`cloudops offers` — search purchasable instance types / GPU offers with prices."""
...
from .. import render
from ..providers import OfferFilter, resolve_providers


def main(argv: "Optional[list[str]]" = None) -> int:
    parser = argparse.ArgumentParser(
        prog="cloudops offers",
        description="Search purchasable instance types / GPU offers with prices")
