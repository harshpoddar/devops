"""`cloudops terminate` — terminate/destroy an instance. AWS instances not created
by this skill (missing the managed-by=cloudops-skill tag) require --force."""
...
def main(argv: "Optional[list[str]]" = None) -> int:
    parser = argparse.ArgumentParser(
        prog="cloudops terminate", description="Terminate a cloud instance")
